# Capstone_2
A data‑driven comparison of two EmporiUm sales territories using Python, merged datasets, and clear visual insights
EmporiUm is a growing student bookstore chain that sells textbooks, tech gear, art supplies, and a variety of other products both in‑store and online. The company organizes its sales operations by region, with each region containing multiple sales territories that are managed and evaluated separately.
